#!/usr/bin/env python3
"""
SubVigil - The first context-aware, AI-augmented attack surface mapper.
...
<title>SubVigil Report — {self.domain}</title>
...
<div class="page">
  ...
  <div class="rpt-footer">
    <span>Generated by <a href="https://github.com/bidhata/SubVigil" style="color:var(--accent);text-decoration:none;">SubVigil</a> &mdash; by <a href="https://github.com/bidhata" style="color:var(--accent);text-decoration:none;">Krishnendu Paul</a></span>
...
$(document).ready(function() {{
  ...
  $('#securityTable').DataTable(cfg);
    ...
    def run(self):
        ...
        print(f"{Fore.CYAN}SubVigil - The first context-aware, AI-augmented attack surface mapper.")
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="SubVigil - The first context-aware, AI-augmented attack surface mapper.",
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog="""
Examples:
  python subvigil.py example.com
  python subvigil.py example.com -t 100 --fast
  python subvigil.py example.com --stealth --proxy-file proxies.txt
  python subvigil.py example.com --wordlist custom.txt --timeout 60
  python subvigil.py example.com --shodan-key YOUR_API_KEY
        """
    )
